...
#         creating more frame
        ...
        self.delivered_btn = Button(self.product_panal, image=self.img, compound=LEFT, text=" Reply Comment",
        ...
        self.windoe()
    def windoe(self):
        data = db.get_all_comment_no_specifi()
    ...
    def view_comment(self):
        ...
        self.ide=int(id[0])
        print(self.ide)
        add_comment_window.update_comment(self.ide)
